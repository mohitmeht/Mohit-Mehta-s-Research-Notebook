...
%\include{Different_boundary_conditions}
...
\begin{itemize}
\item Dendrite growth rate and dendrite initiation time depends on \ce{c_{Li}}  and \ce{j_{dis}} \cite{Nishikawa2010}
...
\item Brissot~\cite{Brissot1999} discussed the onset of dendrites as a function of \ce{j_{dis}} and the dendrite initiation time
